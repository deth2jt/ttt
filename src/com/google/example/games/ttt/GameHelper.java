...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        Log.d(TAG, "mConnectionResult1: " + mConnectionResult);
        ...
        if (!shouldResolve) {
            ...
            mConnectionResult = result;
            Log.d(TAG, "mConnectionResult2: " + mConnectionResult);
            mConnecting = false;
            notifyListener(false);
            return;
        }
    ...
    void resolveConnectionResult() {
        ...
        Log.d(TAG, "here1");
        Log.d(TAG, "mConnectionResult3: " + mConnectionResult);
        debugLog("resolveConnectionResult: trying to resolve result: "
                + mConnectionResult);
        if (mConnectionResult.hasResolution()) {
            // This problem can be fixed. So let's try to fix it.
            debugLog("Result has resolution. Starting it.");
            Log.d(TAG, "mConnectionResult4: " + mConnectionResult);
            try {
                ...
                Log.d(TAG, "RC_RESOLVE: " + RC_RESOLVE);
            ...
            // error.
        	Log.d(TAG, "here");
        	Log.d(TAG, "mConnectionResult5: " + mConnectionResult);
